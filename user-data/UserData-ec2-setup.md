...
## User Data para la instancia - Image Builder##
...
- **Instalación de paquetes:
	 ...
	 - Instalar php y  php-fpm (version 8.2)
	 - Instalar módulos de php requeridos para la aplicación
	 - Instalar para composer para instalar dependencias adicionales
	 - Instalación de paquetes de Codedeploy
- **Configuración de paquetes:
	- Apache
	- Agente de Codedeploy (opcional ya lo hace Codedeploy via SSM)
...
# Crear página de prueba inicial
...
<body>
    <div class="container">
        ...
        <div class="status">
            ...
            <p>Esperando deployment de la aplicación...</p>
        </div>
        <hr>
